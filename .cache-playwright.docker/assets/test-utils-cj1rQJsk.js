import { r as reactExports, o as reactDomExports, g as getDefaultExportFromCjs } from './index-BMQhalnF.js';
...
'use strict';var k=reactExports,l=reactDomExports;function m(a){var b=a,c=a;if(a.alternate)for(;b.return;)b=b.return;else {a=b;do b=a,0!==(b.flags&4098)&&(c=b.return),a=b.return;while(a)}return 3===b.tag?c:null}function n(a){if(m(a)!==a)throw Error("Unable to find node on an unmounted component.");}
...
var testUtils = testUtils$3.exports;

"use strict";
if (true) {
  testUtils$3.exports = reactDomTestUtils_production_min;
} else {
  module.exports = require("./cjs/react-dom-test-utils.development.js");
}

var testUtilsExports = testUtils$3.exports;
const testUtils$1 = /*@__PURE__*/getDefaultExportFromCjs(testUtilsExports);

const testUtils$2 = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  default: testUtils$1
}, [testUtilsExports]);

export { testUtils$2 as t };
//# sourceMappingURL=test-utils-cj1rQJsk.js.map
